              ...
              <!--
                <div class="btn-group">
                   ...
                   data-placement="top" title="Member">
                    <i class="fa fa-users"></i> Choose Discount
                 </a> 
...
<!-- FormSubmit -->
<form method="POST" action="<?php echo base_url();?>order/update" id="FormSubmit">
    <input type="hidden" id="id" name="id" value="<?php echo $detail['payment']->sales_id;?>"/>
                  ...
                  <?php foreach($table as $t): ?>
                    <tr>
                        <td>
                            <?php
                               $checked = "";
                               $list_table = explode(",",$detail['table_id']);
                               foreach($list_table as $tb){
                                   if($tb==$t->id_main){
                                       $checked = "checked=true";
                                   }
                               }
                            ?>
                            <input type="checkbox" <?php echo $checked;?> class="flat-red select-table" value="<?php echo $t->id_main;?>">
                        </td>
...
<script type="text/javascript">
   var listmenu = <?php echo json_encode($detail['payment']->items);?>;
   var member = { id : "<?php echo $detail['member_id']!=null ? $detail['member_id'] : null ;?>", name : "<?php echo $detail['guest_name'] !=null ? $detail['guest_name'] : null ;?>" };
   var tableorder = "<?php echo $detail['table_id'];?>";
   var transaction_number = "<?php echo $detail['payment']->transaction_number;?>";
</script>
